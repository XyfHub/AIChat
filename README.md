# AIChat — Terminal AI Chat

A terminal-based AI chat application built in Java 21, featuring a pluggable tool-calling system and MCP (Model Context Protocol) support.

## Features

- **Terminal UI** — Rich terminal rendering with frames, colors, and interactive prompts via the Clique UI library
- **Pluggable tools** — Built-in tools for file editing, shell execution, web search, and more
...
MCP servers are configured in `~/.aiChat/mcp-servers.json`:
